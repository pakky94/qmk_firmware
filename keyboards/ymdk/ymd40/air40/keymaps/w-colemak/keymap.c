...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_ortho_4x12(
        ...
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_DEL,  KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR,
        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,
    ...
    [_RAISE] = LAYOUT_ortho_4x12(
        ...
        KC_DEL,  KC_RALT,KC_TILD,S(KC_QUOT),_______, _______, _______, KC_PIPE, KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN,
    ...
    [_OS] = LAYOUT_ortho_4x12(
        _______, _______, _______, _______, _______, _______, _______, TO(_AD), TO(_GL), TO(_ML), _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
